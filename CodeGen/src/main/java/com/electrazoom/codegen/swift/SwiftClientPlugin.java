...
public class SwiftClientPlugin extends BaseGenerator {
    private static final Logger LOG = LoggerFactory.getLogger(SwiftClientPlugin.class);

    public SwiftClientPlugin() {
        super();
        setLogData(false);
    }
    ...
    public static void main(String args[]) {
        ...
        SwiftClientPlugin generator = new SwiftClientPlugin();
        generator.addFileGenerator(new SwiftRpcClientGenerator(response));
